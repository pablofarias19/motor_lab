...
final class InspectionPdfRenderingTest extends TestCase
{
    public function run(): void
    {
        ...
        $this->assertTrue(str_contains($inspectionSearch, 'recomendacion final: control de dano y prueba inmediata'), 'El PDF de riesgo de inspección debe exponer la recomendación laboral final.');
        $this->assertTrue(str_contains($inspectionSearch, 'recomendacion principal: control de dano y prueba inmediata'), 'El PDF de riesgo de inspección debe exponer la recomendación ARCA principal.');
        ...
        $this->assertTrue(str_contains($inspectionSearch, 'escenario b - inspeccion en curso'), 'El PDF de riesgo de inspección debe mostrar escenarios MILI coherentes.');
        ...
        $this->assertTrue(str_contains($inspectionSearch, 'evento fiscal: inspeccion'), 'El PDF de riesgo de inspección debe exponer el evento fiscal.');
        ...
        $this->assertTrue(str_contains($inspectionSearch, 'escenario optimo mili: escenario b'), 'El PDF de riesgo de inspección debe informar el escenario óptimo.');
        $this->assertTrue(str_contains($inspectionSearch, 'modelo operativo'), 'El PDF de riesgo de inspección debe incluir el modelo operativo.');
