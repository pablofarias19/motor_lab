        ...
        <div class="motor-container" style="max-width: 1000px;">
            ...
            <div class="card knowledge-toolbar" style="margin-bottom:24px;">
                <form method="GET" action="jurisprudencia.php" style="display:flex; gap:12px; align-items:end; flex-wrap:wrap;">
                    ...
                    <?php if ($busqueda): ?>
                    <a href="<?= htmlspecialchars(ml_url('jurisprudencia.php')) ?>" class="btn btn-secondary" style="margin-bottom:0;">✕ Limpiar</a>
                    <?php endif; ?>
                </form>
            </div>
            ...
            <div class="card">
                <div class="empty-state">
                    ...
                    <a href="<?= htmlspecialchars(ml_url('jurisprudencia.php')) ?>" class="btn btn-primary" style="margin-top:1rem;">Ver toda la jurisprudencia</a>
                    <?php else: ?>
