...
### 3.2 Agregar 6 PASOS de Procesamiento

Ver sección "PASO 1-6" en documento: `INTEGRACION_PROCESAR_ANALISIS_v2.1.md`

**Secuencia:**
1. **PASO 0**: Validación Ley Bases (new)
2. **PASO 1**: Obtención RIPTE (new)
3. **PASO 2**: Cálculo IBM dinámico (modificado)
4. **PASO 3**: Pisos mínimos (new)
5. **PASO 4**: IRIL Engine (existente)
6. **PASO 5**: Multas condicionadas (new)
7. **PASO 6**: Escenarios + intereses (modificado)
